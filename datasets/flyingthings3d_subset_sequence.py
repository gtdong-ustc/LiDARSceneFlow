...
class FlyingThings3DSubset(data.Dataset):
    ...
    def __getitem__(self, index):
        pc1_loaded, pc2_loaded, flow1_loaded = self.pc_loader(self.samples[index])
        ...
        pc1_transformed, pc2_transformed, sf_transformed = self.transform([pc1_loaded, pc2_loaded, flow1_loaded])
    ...
    def pc_loader(self, path):
        ...
        random_number = random.randint(0, int(len(file_list)/2) - 2)
