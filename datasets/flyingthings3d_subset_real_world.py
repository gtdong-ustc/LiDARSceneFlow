...
class FlyingThings3DSubset(data.Dataset):
    ...
    def __init__(self,
        ...
        self.root = osp.join(data_root, 'raw_pcd_with_occlusion')
        self.train = train
    ...
    def __getitem__(self, index):
        pc1_loaded, pc2_loaded, flow_loaded= self.pc_loader(self.samples[index])
        ...
        pc1_transformed, pc2_transformed, sf_transformed = self.transform([pc1_loaded, pc2_loaded, flow_loaded])
    ...
    def pc_loader(self, path):
        ...
        flow1 = np.load(osp.join(path, 'flow.npy'))
        pc2 = pc1 + flow1
